 ...
 *
 * @wordpress-plugin
 * Plugin Name:       Wordpress Person List
 * Description:       List Persons and show them on Post Content
 * Version:           1.0.0
 */
...
function init() {
	...
	$wpr_rest            = Endpoint\Person::get_instance();
	$wpr_posttype_person = PostType\Person::get_instance();
	$wpr_block           = Block::get_instance();
}
